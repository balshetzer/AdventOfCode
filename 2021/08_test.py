...
def test():
  table(asserter, 8, [(sample, 26), (input, 473)], [(small, 5353), (sample, 61229), (input, 1097568)])
...
input = '''dg debg edgfc afbgcd efdbgc gdc bfdceag bfdec febcad gfaec | dcg bdaegfc egbd dcgfe
